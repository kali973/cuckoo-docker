...
class Bootkit(Signature):
    ...
    filter_apinames = set(
        ["NtCreateFile", "NtDuplicateObject", "NtOpenFile", "NtClose", "NtSetInformationFile", "NtWriteFile",
    ...
    def on_call(self, call, process):
        ...
        if call["api"] == "NtDuplicateObject" and call["status"]:
            ...
            if filename and (filename.lower() == "\\??\\physicaldrive0" or filename.lower().startswith(
                    "\\device\\harddisk")) and access & 0x40000002:
