...
def sqldump(dburi, dirpath):
    ...
    print
    "We can make a SQL database backup as follows:"
    print
    "input cmd  =>", cmd
    print
    "output SQL =>", cwd("backup.sql")
...
def import_cuckoo(username, mode, dirpath):
    ...
    print
    "We've identified a Cuckoo Sandbox %s installation!" % version
    ...
    print
    print
    "You have successfully imported your old version of Cuckoo!"
    print
    "However, in order to get up-to-date, you'll probably want to"
    print
    yellow("run the community command"),
    print
    "by running", red("'cuckoo community'"), "manually."
    print
