...
urlpatterns = [
    ...
    url(r"^(?P<task_id>\d+)/compare/(?P<compare_with_task_id>\d+)/$", AnalysisCompareRoutes.both,
        name="analysis/compare/both"),
    url(r"^(?P<task_id>\d+)/compare/(?P<compare_with_hash>.*)/$", AnalysisCompareRoutes.hash,
        name="analysis/compare/hash"),
