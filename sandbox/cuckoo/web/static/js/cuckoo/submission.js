...
// appends a helper to handlebars for humanizing sizes
                                        ...
                                        configure: function configure(form) {
                                            ...
                                            var network = new this.TopSelect({
                                                ...
                                                options: [{
                                                    name: 'none',
                                                    value: 'none',
                                                    disabled: routing_prefs['none'] === false
                                                }, {
                                                    name: 'drop',
                                                    value: 'drop',
                                                    disabled: routing_prefs['drop'] === false
                                                }, {
                                                    name: 'internet',
                                                    value: 'internet',
                                                    disabled: routing_prefs['internet'] === false
                                                }, {
                                                    name: 'inetsim',
                                                    value: 'inetsim',
                                                    disabled: routing_prefs['inetsim'] === false
                                                }, {
                                                    name: 'tor',
                                                    value: 'tor',
                                                    disabled: routing_prefs['tor'] === false
                                                }],
                                                extra_select: {
                                                    title: 'VPN via',
                                            ...
                                            var priority = new this.TopSelect({
                                                ...
                                                options: [{
                                                    name: 'low',
                                                    value: 1,
                                                    className: 'priority-s'
                                                }, {name: 'medium', value: 2, className: 'priority-m'}, {
                                                    name: 'high',
                                                    value: 3,
                                                    className: 'priority-l'
                                                }]
                                            }).on('change', function (value) {
                    ...
                    form: {
                        ...
                        configure: function configure(form) {
                            ...
                            var priority = new this.TopSelect({
                                ...
                                options: [{name: 'low', value: 1, className: 'priority-s'}, {
                                    name: 'medium',
                                    value: 2,
                            ...
                            var timeout = new this.TopSelect({
                                ...
                                units: 'seconds',
                                options: [{name: 'short', value: 60, description: '60'}, {
                                    name: 'medium',
                                    value: 120,
                                    description: '120'
                                }, {name: 'long', value: 300, description: '300'}, {name: 'custom', manual: true}]
                            });
        ...
        "./components/FileTree": 3,
        "./components/InterfaceControllers": 4,
        "./components/SubmissionTaskTable": 5
    }]
}, {}, [6])
